<template>
    <div>
                    ...
                    <div class="row global-cat-row mt-5">
                        ...
                        <div class="col-lg-9 col-md-12 col-12 global-carousel-owl-col">
                           ...
                           <ul>
                               ...
                               <li title="Quick View" class="d-lg-block d-md-block d-none">
                                   <a href="#" class="compare" data-bs-toggle="modal" data-bs-target="#product-modal4" @click.prevent="productInfo(hot.id)">
                       ...
                       <div class="product-details text-center pt-2">
                           ...
                           <ul>
                               ...
                               <li title="Quick View" class="d-lg-block d-md-block d-none">
                                   <a href="#" class="compare" data-bs-toggle="modal" data-bs-target="#product-modal4" @click.prevent="productInfo(prod.id)">
                                       <i class="fas fa-search"></i>
                                   </a>
                               </li>
                               <li title="Add To Wishlist">
            ...
            <!--modal start-->
            <div class="modal fade " id="product-modal4" tabindex="-1" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true">
